 ...
 * @author Ariel
 */
public class GNULinux implements PC{
    
  private String Os="Linux Operative System";
  private String Ip="";
 ...
 public GNULinux(String Os, int port, String serverName) {
